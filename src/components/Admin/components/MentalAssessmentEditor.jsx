...
const MentalAssessmentEditor = ({
  ...
  return (
    <section className="bg-white border shadow-sm rounded-xl p-6 mb-10">
      <h2 className="text-xl font-semibold mb-4">Mental Health Assessment Questions</h2>
...
export default MentalAssessmentEditor;
